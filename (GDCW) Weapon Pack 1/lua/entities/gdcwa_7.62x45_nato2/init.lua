...
self.Flightvector 	= self.Entity:GetUp()*((390*40.4)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.TissueDamage	= math.Rand(10,30)			// Player damage is multiplied by 2 for some reason
self.BallisticDrag	= 110					// Fraction of velocity lost per tick, higher is less
