...
self.Flightvector 	= self.Entity:GetUp()*((550*40.4)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.TissueDamage	= math.Rand(80,140)			// Player damage is multiplied by 2 for some reason
