...
self.Flightvector 	= self.Entity:GetUp()*((300*40.4)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.TissueDamage	= math.Rand(10,23)			// Player damage is multiplied by 2 for some reason
self.BallisticDrag	= 190			// Fraction of velocity lost per tick, higher is less
self.Drift		= 0.6					// How much the bullet will drift in flight (Inaccuracy)
