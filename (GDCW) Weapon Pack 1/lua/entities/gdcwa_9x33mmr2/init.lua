...
self.Flightvector 	= self.Entity:GetUp()*((200*40.4)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.TissueDamage	= math.Rand(40,80)			// Player damage is multiplied by 2 for some reason
self.BallisticDrag	= 160			// Fraction of velocity lost per tick, higher is less
